...
\text{}{En este primer ejemplo, tenemos la expresión de una potencia compleja $x^{y}$. La} 
\text{fórmula general para una potencia compleja es:}
...
\text{}{Este es un resultado conocido como la serie de Basilea, que es importante en la teoría de series infinitas}
\end{document}
